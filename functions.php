...
function proyecto_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'proyecto_content_width', 640 );
}
...
function proyecto_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'proyecto' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'proyecto' ),
...
function proyecto_scripts() {
	...
	wp_enqueue_script( 'bootstrap-js', get_template_directory_uri() . '/assets/js/bootstrap.min.js', array ('jquery'), 1.1, false);
	wp_enqueue_script( 'proyecto-js', get_template_directory_uri() . '/assets/js/custom.js', array('jquery'), '20151215', true ); 
	wp_enqueue_script( 'footer', get_template_directory_uri() . '/assets/js/footer.js', array (), 1.1, true);
